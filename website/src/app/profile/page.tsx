...
import { ArrowLeft, User, Briefcase, Calendar, Shield, Mail, Phone, FileText } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 md:p-12 font-sans">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* 🟢 ฝั่งซ้าย: ข้อมูลส่วนตัว (ทุกคนเห็น) */}
        <div className="lg:col-span-1 space-y-6">
          ...
          {/* Card 2: About Me (Bio) ✅ เอากลับมาให้แล้วครับ! */}
          ...
          {isRecruiter ? (
            ...
            <>
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 min-h-[300px] flex flex-col items-center justify-center text-center">
                 ...
                 <h3 className="text-lg font-bold text-gray-800">ประวัติการสมัครงาน</h3>
                 <p className="text-gray-500 mt-2 max-w-sm">
                   คุณยังไม่ได้สมัครงานในขณะนี้
                 </p>
                 <Link href="/dashboard" className="mt-6 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                    ค้นหางานที่น่าสนใจ
                 </Link>
              </div>
            </>
